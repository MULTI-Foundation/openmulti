...
import { catalogModels, candidatesFor, fastCandidates, imageCandidates, visionCandidates, audioCandidates, EMBEDDING_MODEL } from './catalog.js'
...
export function knownModelIds(): string[] {
  ...
  // Les slots hors tiers (fast, vision, audio) font partie des modèles servis : leurs
